...
import 'package:viva/auth/domain/use_case/google_or_facebook_sign_in_usecase.dart';
...
class AuthController extends GetxController {
  ...
  void signUpWithEmailAndPassword(String email, String password) async {
    ...
    result.fold(
      ...
      (right) async {
        bool response = await baseFirebaseAuthRemoteDataSource
            .addUserInUserCollection(
              UserModel(
                id: right.uid,
                email: right.email,
        ...
        if (response)
          ...
          Get.snackbar("add user to collection", "message");
      },
    );
